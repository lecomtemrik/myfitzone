...
class IngredientRecetteController extends AbstractController
{
    ...
    {
        return $this->render('ingredient_recette/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('ingredient_recette/new.html.twig', [
    ...
    {
        return $this->render('ingredient_recette/show.html.twig', [
            'ingredient_recette' => $ingredientRecette,
        ]);
    }
    ...
    public function edit(Request $request, IngredientRecette $ingredientRecette): Response
    {
        ...
        return $this->render('ingredient_recette/edit.html.twig', [
            'ingredient_recette' => $ingredientRecette,
            'form' => $form->createView(),
        ]);
    }
