...
class SousCategorieController extends AbstractController
{
    ...
    {
        return $this->render('redacteur/sous_categorie/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('redacteur/sous_categorie/new.html.twig', [
    ...
    {
        return $this->render('redacteur/sous_categorie/show.html.twig', [
            'sous_categorie' => $sousCategorie,
        ]);
    }
    ...
    public function edit(Request $request, SousCategorie $sousCategorie): Response
    {
        ...
        return $this->render('redacteur/sous_categorie/edit.html.twig', [
            'sous_categorie' => $sousCategorie,
            'form' => $form->createView(),
        ]);
    }
